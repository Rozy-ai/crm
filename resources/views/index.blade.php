                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                                            ...
                                            <div class="card-body text-center pt-0">
                                                <!--begin::Image input-->
                                                <!--begin::Image input placeholder-->
                                                <style>.image-input-placeholder { background-image: url('https://business.getpits.com/front/demo1/dist/assets/media/svg/files/blank-image.svg'); } [data-theme="dark"] .image-input-placeholder { background-image: url('https://business.getpits.com/front/demo1/dist/assets/media/svg/files/blank-image-dark.svg'); }</style>
                                                <!--end::Image input placeholder-->
                                                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                                                    <!--begin::Preview existing avatar-->
                                                    <div class="image-input-wrapper w-150px h-150px"></div>
                                                            ...
                                                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                                                                ...
                                                                <div class="d-flex flex-stack flex-grow-1">
                                                                    ...
                                                                    <div class="fw-semibold">
                                                                        ...
                                                                        <a id="kt_engage_demos_toggle" href="https://business.getpits.com/front/demo1/dist/utilities/wizards/vertical.html" class="fw-bold">Publish my mechanical workshop</a></div>
                                                                    </div>
                                                                    <!--end::Content-->
                                                                </div>
                                                                <!--end::Wrapper-->
        ...
        <div class="modal-dialog mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <img alt="Logo" src="https://business.getpits.com/front/demo1/dist/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Invite Gmail Contacts</div>
